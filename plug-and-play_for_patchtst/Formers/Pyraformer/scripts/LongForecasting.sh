...
do
uv run long_range_main.py -data ETTh1 -input_size 96 -predict_step $pred_len -n_head 6 >../logs/LongForecasting/Pyraformer_ETTh1_$pred_len.log
done
uv run long_range_main.py -data ETTh1 -input_size 96 -predict_step 720 -inner_size 5 -n_head 6 >../logs/LongForecasting/Pyraformer_ETTh1_720.log

# # ETTh2
for pred_len in 96 192 336
do
uv run long_range_main.py -data ETTh2 -input_size 96 -data_path ETTh2.csv -predict_step $pred_len -n_head 6 >../logs/LongForecasting/Pyraformer_ETTh2_$pred_len.log
done
uv run long_range_main.py -data ETTh2 -input_size 96 -data_path ETTh2.csv -predict_step 720 -inner_size 5 -n_head 6 >../logs/LongForecasting/Pyraformer_ETTh2_720.log

# ETTm1
uv run long_range_main.py -data ETTm1 -data_path ETTm1.csv -input_size 96 -predict_step 96 \
 -dropout 0.2 -n_head 6 -d_model 256 -d_bottleneck 64 -d_k 64 -d_v 64 >../logs/LongForecasting/Pyraformer_ETTm1_96.log
uv run long_range_main.py -data ETTm1 -data_path ETTm1.csv -input_size 96 -predict_step 192 \
...
uv run long_range_main.py -data ETTm1 -data_path ETTm1.csv -input_size 96 -predict_step 336 \ 
...
uv run long_range_main.py -data ETTm1 -data_path ETTm1.csv -input_size 96 -predict_step 720 \
...
# ETTm2
uv run long_range_main.py -data ETTm2 -data_path ETTm2.csv -input_size 96 -predict_step 96 \
 -dropout 0.2 -n_head 6 -d_model 256 -d_bottleneck 64 -d_k 64 -d_v 64 >../logs/LongForecasting/Pyraformer_ETTm2_96.log
uv run long_range_main.py -data ETTm2 -data_path ETTm2.csv -input_size 96 -predict_step 192 \
...
uv run long_range_main.py -data ETTm2 -data_path ETTm2.csv -input_size 96 -predict_step 336 \
...
uv run long_range_main.py -data ETTm2 -data_path ETTm2.csv -input_size 96 -predict_step 720 \
...
# ili
uv run long_range_main.py  -window_size [2,2,2] -data_path national_illness.csv -data ili \
...
# Electricity
uv run long_range_main.py  -data_path electricity.csv -data electricity \
...
# Exchange
uv run long_range_main.py  -data_path exchange_rate.csv -data exchange \
...
# Traffic
uv run long_range_main.py  -data_path traffic.csv -data traffic \
...
# Weather
uv run long_range_main.py  -data_path weather.csv -data weather \
